...
вещи владельцев с действующим согласием на персонализацию. Отдельная отметка
о передаче фото внешнему AI-сервису здесь не нужна: обработка идёт на оборудовании
Оператора и покрывается общим согласием при регистрации.
