...
| [sales_offer.md](sales_offer.md) | Оффер «Размещение под ключ» 5000₽ + шаблон холодного письма + плейбук продажи + критерии списка кандидатов (`_docs/cold-sales-candidates.csv`) + **§11 плейбук входящего лида с лендинга** (квалификация, развилка бесплатно/5000₽, шаблон ответа). От 2026-06-22, §11 от 2026-07-26 |
