...
class WarmOfferService
{
    ...
    public function buildDraft(array $lead, array $similar): array
    {
        ...
        $body = sprintf(
            ...
            "%s" .
            "За 5 000₽ разово доведём карточку до полного вида и задействуем поверхности, которые " .
            "сами контролируем: кнопки на ваш сайт и соцсети со счётчиком переходов, FAQ под ответы " .
            "Алисы и AI-поиска, анонс в Telegram и VK, по желанию — каталог до 50 товаров из вашего " .
            "файла, а через 30 дней — отчёт цифрами. Без маркетплейсов; клиент и выручка — ваши.\n\n" .
