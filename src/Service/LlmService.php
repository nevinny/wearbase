...
- Первое предложение ответа — прямой самодостаточный ответ на вопрос (определение / конкретное число / да-нет + факт), понятный без чтения вопроса; дальше — детали.
...
- FAQ: три пары, минимум две. Если поисковых фраз не дали, строй вопросы прямо из
  ФАКТОВ — их всегда хватает минимум на три: «какие стили преобладают у брендов
  города», «что выпускает <конкретный бренд>», «какие ещё марки города есть
  в каталоге». Одна пара — это провал задачи, а не «мало фактов».
