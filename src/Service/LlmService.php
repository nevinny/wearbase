...
- Затем блок «## Сравнение брендов» — markdown-таблица, столбцы «Бренд | Ассортимент | Размеры | Цены | Город», по строке на бренд, ТОЛЬКО факты; где данных нет — «—». Ничего не выдумывай.
...
EOT;
    ...
    public function generateGuide(
        ...
        $kwRule = ($keywords !== null && trim($keywords) !== '')
            ? "\n- SEO: органично вплети 2–4 поисковых запроса (без переспама): {$keywords}"
            : '';
